    ...
    <style>
        * {
        ...
        :root {
            ...
            --radius-lg: 16px;
            --radius-md: 12px;
            --shadow-card: 0 12px 32px rgba(0, 20, 50, 0.06), 0 4px 12px rgba(0, 0, 0, 0.02);
            --shadow-hover: 0 20px 48px rgba(0, 20, 50, 0.10);
        ...
        .hero {
            ...
            text-align: center;
            background:
                linear-gradient(145deg, rgba(11, 30, 51, 0.70), rgba(11, 30, 51, 0.50)),
        ...
        /* newsletter */
        .newsletter {
            background: linear-gradient(145deg, #0b1e33, #1a3755);
            color: white;
            border-radius: var(--radius-xl);
            padding: 52px 32px;
            text-align: center;
